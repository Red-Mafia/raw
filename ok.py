...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;94m \n\x1b[1;92m \n\x1b[1;93m \n\x1b[1;92m \n\x1b[1;94m     #     #    #    #       ### #    # \n\x1b[1;92m     ##   ##   # #   #        #  #   #  \n\x1b[1;93m     # # # #  #   #  #        #  #  #   \n\x1b[1;95m     #  #  # #     # #        #  ###    \n\x1b[1;94m     #     # ####### #        #  #  #\n\x1b[1;96m     #     # #     # #        #  #   #\n\x1b[1;97m     #     # #     # ####### ### #    #                                      \n\x1b[1;94m                                 \n     \x1b[31;1m[\x1b[43;1m This tool is Premium not for Free \x1b[00;1m\x1b[31;1m ]\n\n     \x1b[32;1mCreator \x1b[37;1m: \x1b[33;1mOkenwa Bright\n     \x1b[32;1mFB ID   \x1b[37;1m: \x1b[33;1mOkenwa Bright\n'

def reg():
    os.system('clear')
    print logo
    print ''
    print '\x1b[1;32;1m Enjoy Speed Cloning'
    print ''
    time.sleep(1)
    try:
        to = open('/sdcard/.okenwa.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/Red-Mafia/fiile/main/server.txt').text
    if to in r:
        ...
        print ' \x1b[1;92mYour Id Is Not Approved You Mother Fucker '
        print ' \x1b[1;92mOga Copy the id and send to admin'
...
def log_menu_s():
    s = raw_input(' \x1b[1;94m\xe2\x95\xb0\xe2\x94\x80RIAZ\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
